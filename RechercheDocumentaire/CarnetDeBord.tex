...
\begin{itemize}
 ...
 \section*{\LARGE{Conclusion}}
   \end{center}
 \Large{\paragraph{}
 Dans ce carnet de bord, on a exposé la méthode suivie et les moyens utilisés afin d'assurer une bonne 
 ...
 d'outil dépendait du type d'information désirée. A la fin, une évaluation des sources selon des 
